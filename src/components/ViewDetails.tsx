...
export default function ViewDetails({
  ...
  return (
    <div className="flex-1 p-6">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <span className="text-4xl font-semibold my-6 mx-10 text-gray-600">
              {data.heading || data.title || "Details"}
            </span>
          </button>
        </div>
      ...
      {/* Type and Email Info */}
      <div className="mb-4">
        <span className="inline-block bg-blue-100 text-blue-700 px-3 py-1 rounded-full mr-2 text-sm font-semibold">
          {type?.toUpperCase()}
        </span>
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-8">
        ...
        <div className="p-8">
          <h2 className="text-2xl font-bold text-gray-600 mb-4">
            {data.heading || data.title || "No Title"}
          </h2>
            ...
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-gray-800">
                  {data.student || data.assignedTo || "N/A"}
                </span>
              </div>
            </div>
