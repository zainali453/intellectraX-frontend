...
const EditQuizModal: React.FC<EditQuizModalProps> = ({
  ...
  const handleTimeSlotChange = (
    ...
    if (!formData.dueDate) return alert("Please select due date first");
        ...
        <div className='p-6'>
          ...
          <div className='space-y-6'>
            ...
            <div>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                <TimeSelector
                  ...
                  onChange={(value) => handleTimeSlotChange("startTime", value)}
                  placeholder='Start Time'
                  format24={false}
                />
                <TimeSelector
                  value={getTimeString(formData.endTime)}
                  onChange={(value) => handleTimeSlotChange("endTime", value)}
              ...
              {formData.startTime && formData.endTime && (
                <span className='block text-sm font-medium text-gray-700 mt-2'>
                  Time Limit:{" "}
                  {calculateTimeLimit(
                    getTimeString(formData.startTime),
                    getTimeString(formData.endTime)
                  )}
                </span>
              )}
            </div>
            ...
            <CustomUpload
              ...
              placeholder='Upload quiz attachment'
              uploading={uploading}
              error={uploadError}
            />
          </div>
