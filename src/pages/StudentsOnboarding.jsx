...
const StudentOnboarding = () => {   
    ...
    const handleFinish = async () => {
        ...
        try {
            ...
            const response = await AuthService.completeOnboarding(user.email, studentPayload, user.role);
            ...
            if (response && response.success) {
                ...
                navigate('/dashboard');
            } else if (response && response.message !== "Student profile already exists") {
        ...
        <div className="flex items-center justify-center bg-gray-100 py-2 sm:py-4 md:py-6 px-3 sm:px-4 md:px-6 min-h-screen">
            <div className="w-[800px] max-w-full mx-auto bg-white rounded-lg shadow-lg p-4 md:p-6 min-h-[500px] max-h-[90vh] flex flex-col">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            onChange={(e) => setOnboardingData(prev => ({ ...prev, learningGoals: e.target.value }))}
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setOnboardingData(prev => ({ ...prev, parentEmail: e.target.value }))}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setOnboardingData(prev => ({ ...prev, parentContact: e.target.value }))}
                ...
                <div className="space-y-2 sm:space-y-3 mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-200 flex-shrink-0">
                    ...
                    <button
                        onClick={handleNext}
                        disabled={loading || !isStepValid(onboardingData, currentStep, 'student')}
