...
const ProfileView = () => {
  ...
  useEffect(() => {
    console.log(
      "[ProfileView] Using email for profile:",
      emailForProfile,
      "and role:",
      normalizedRole
    );
          ...
          return (
            <div className="space-y-6">
              ...
              <ClassSubjects
                ...
                onChange={(updated) =>
                  setStudentFormData((prev) => ({ ...prev, ...updated }))
                }
              />
            </div>
          );
            ...
            <div className="space-y-6">
              ...
              <AvailabilitySchedule
                ...
                onChange={(availability) =>
                  setStudentFormData((prev) => ({ ...prev, availability }))
                }
              />
            </div>
          );
        ...
        <div className="w-64 space-y-6">
          <div className="bg-white p-6 rounded-xl shadow-sm">
            ...
            <div className="bg-white mt-10 overflow-hidden">
              {(normalizedRole === "Admin"
                ? ["Profile", "Security", ...(isSettingsRoute ? [] : [])]
                ...
                <button
                  ...
                  className={`w-full px-6 py-3 text-left transition-colors
                                    ${
                                      activeTab === tab
                                        ? "bg-teal-50 text-bgprimary"
                                        : "text-gray-600 hover:bg-teal-50 hover:text-bgprimary"
                                    }
                                `}
                >
                  {tab}
