...
const DashMain = ({ title }) => {
  ...
  return (
    <div className="flex flex-col align-center">
      <h1 className="text-4xl font-semibold my-6 mx-10 text-gray-600">
        {title}
      </h1>
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center">
            ...
            <button
              ...
              className="bg-teal-600 text-white font-semibold py-2 px-4 rounded-3xl hover:bg-teal-700 transition"
            >
              View All
            </button>
          </div>
      ...
      <div className="bg-white rounded-2xl mx-auto my-10 px-6 py-8 w-[96%]">
        ...
        {showAssignmentQuizCharts && (
          <>
            <div className="mb-6">
              <PerformanceChart type="Assignment" />
            </div>
            <div className="mb-6">
              <PerformanceChart type="Quiz" />
            </div>
          </>
        )}
      </div>
