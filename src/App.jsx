  ...
  return (
    <UserProvider>
      <div className="bg-gray-100 h-screen flex flex-col">
        <Topbar />
        <main className="h-screen flex flex-col overflow-hidden items-center justify-center">
          <Routes>
            {/* Public routes */}
            <Route path="/" element={
            ...
            <Route path="/dashboard" element={
              ...
              <Route path="teachers/:email/:role" element={
                <AuthGuard requireAuth={true}>
                  <ProfileView />
                </AuthGuard>
              } />
              ...
              <Route path="/dashboard/quizzes/:id" element={
                <AuthGuard requireAuth={true}>
                  <ViewDetails />
                </AuthGuard>
              } />
              <Route path="/dashboard/classes/:id" element={
                <AuthGuard requireAuth={true}>
                  <ViewDetails />
                </AuthGuard>
              } />
              ...
              <Route path="/dashboard/parents/:id" element={
                <AuthGuard requireAuth={true}>
                  <ViewDetails />
                </AuthGuard>
              } />
